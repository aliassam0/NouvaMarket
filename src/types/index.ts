...
export interface Product {
  ...
  rejectionReason?: string;
  allowAffiliate?: boolean; // هل يسمح بظهور المنتج في الأفلييت للبائعين (افتراضياً true) أم يبيعه المورد وحده حصرياً (false)
  isSupplierExclusive?: boolean; // true إذا اختار المورد بيع المنتج وحده حصرياً دون ظهوره في كتالوج البائعين
}
