...
export function AdminDashboard({ onShowToast, onSwitchToSellerDashboard, onImpersonateSupplier }: AdminDashboardProps) {
  ...
  const handleApproveSeller = (sellerId: string) => {
    ...
    if (approvedSeller) {
      const sessStr = localStorage.getItem('nouvamarket_user_session');
      if (sessStr) {
        try {
          const sess = JSON.parse(sessStr);
          if (sess.email?.toLowerCase() === approvedSeller.email?.toLowerCase()) {
            sess.approvalStatus = 'APPROVED';
            localStorage.setItem('nouvamarket_user_session', JSON.stringify(sess));
          }
        } catch (e) {}
      }
    }
  ...
  const handleApproveWithdrawal = (id: string) => {
    ...
    onShowToast('✔ تم الموافقة وصرف طلب السحب بنجاح!', 'success');
  };
  ...
  const handleRejectWithdrawalSubmit = () => {
    ...
    setWithdrawals((prev) =>
      prev.map((w) =>
        w.id === rejectModalWithdrawalId
          ? { ...w, status: 'REJECTED', rejectionReason: rejectionReasonText || 'عدم مطابقة بيانات الحساب' }
          : w
      )
    );
    setRejectModalWithdrawalId(null);
    setRejectionReasonText('');
    onShowToast('✖ تم رفض طلب السحب وإرجاع المبلغ لمحفظة المسوّق', 'info');
  };
  ...
  return (
    <div className="flex-1 pb-24 overflow-y-auto p-2.5 sm:p-4 text-slate-900 dark:text-slate-100 space-y-4 overflow-x-hidden">
      ...
      <div className="p-4 sm:p-6 rounded-[2rem] bg-gradient-to-r from-slate-950 via-indigo-950 to-slate-900 border border-indigo-800/80 text-white shadow-2xl space-y-5 relative overflow-hidden">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 relative z-10">
          <div className="flex items-center gap-3.5">
            <div className="p-3 rounded-2xl bg-gradient-to-br from-indigo-500/30 to-purple-500/30 border border-indigo-400/40 text-indigo-300 shadow-inner shrink-0">
          ...
          <div className="flex items-center gap-2.5 self-start sm:self-auto flex-wrap">
            <button
              ...
              className="px-3.5 py-2 rounded-2xl bg-indigo-600/40 hover:bg-indigo-600/60 border border-indigo-500/50 text-white font-extrabold text-xs flex items-center gap-2 transition cursor-pointer relative shadow-lg hover:shadow-indigo-500/20"
            ...
            <span className="px-3 py-1.5 rounded-2xl bg-gradient-to-r from-emerald-500/20 to-teal-500/20 text-emerald-300 border border-emerald-500/30 text-xs font-black whitespace-nowrap shadow-xs">
              👑 أدمن رئيسي
            </span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 xs:grid-cols-3 sm:grid-cols-4 md:grid-cols-6 xl:grid-cols-12 gap-2 pt-3 border-t border-indigo-800/60 relative z-10">
          {/* 1. Products */}
          <div
          ...
          >
            ...
            <div className="mt-1 flex items-baseline justify-between">
              ...
              <span className="text-[9px] text-indigo-300 font-medium">عنصر</span>
            </div>
          </div>
          ...
          >
            ...
            <div className="mt-1 flex items-baseline justify-between">
              <span className="text-sm sm:text-base font-black text-emerald-400 font-mono">{sellers.length}</span>
              <span className="text-[9px] text-emerald-300 font-medium">تاجر</span>
            </div>
          </div>
          ...
          <div
            ...
            className={`p-2.5 rounded-2xl border cursor-pointer transition-all duration-200 flex flex-col justify-between ${
              activeAdminTab === 'inventory'
                ...
                : 'bg-slate-900/70 border-indigo-900/80 hover:border-orange-600/80 hover:bg-slate-800/80 text-slate-300'
            }`}
          >
            <div className="flex items-center justify-between text-slate-400 text-[10px] font-bold">
          ...
          <div
            ...
            className={`p-2.5 rounded-2xl border cursor-pointer transition-all duration-200 flex flex-col justify-between ${
              activeAdminTab === 'categories'
                ...
                : 'bg-slate-900/70 border-indigo-900/80 hover:border-pink-600/80 hover:bg-slate-800/80 text-slate-300'
            }`}
          >
            <div className="flex items-center justify-between text-slate-400 text-[10px] font-bold">
          ...
          >
            ...
            <div className="mt-1 flex items-baseline justify-between">
              <span className="text-sm sm:text-base font-black text-teal-300 font-mono">{coupons.length}</span>
              <span className="text-[9px] text-teal-200 font-medium">كوبون</span>
            </div>
          </div>
          ...
          >
            ...
            <div className="mt-1 flex items-baseline justify-between">
              <span className="text-sm sm:text-base font-black text-indigo-300 font-mono">{adminUnreadCount}</span>
              <span className="text-[9px] text-indigo-200 font-medium">تنبيه</span>
            </div>
          </div>
          ...
          <div
            ...
            className={`p-2.5 rounded-2xl border cursor-pointer transition-all duration-200 flex flex-col justify-between ${
              activeAdminTab === 'settings'
                ...
                : 'bg-slate-900/70 border-indigo-900/80 hover:border-slate-600/80 hover:bg-slate-800/80 text-slate-300'
            }`}
          >
            <div className="flex items-center justify-between text-slate-400 text-[10px] font-bold">
            ...
            <div className="mt-1 flex items-baseline justify-between">
              <span className="text-xs font-black text-emerald-400 font-mono">مُنشّط</span>
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2.5">
            ...
            <div className="flex items-center gap-2 flex-wrap">
              ...
              <button
                ...
                className="px-3.5 py-2 rounded-xl bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-500 hover:to-indigo-500 text-white font-extrabold text-xs flex items-center gap-1.5 shadow-md whitespace-nowrap cursor-pointer transition"
              >
              ...
              <button
                ...
                className="px-3.5 py-2 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white font-extrabold text-xs flex items-center gap-1.5 shadow-xs whitespace-nowrap cursor-pointer transition"
              >
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2">
                      ...
                      {p.isNewArrival && (
                        <span className="px-2 py-0.5 rounded-full bg-emerald-100 text-emerald-800 dark:bg-emerald-950 dark:text-emerald-300 text-[9px] font-black">
                          جديد 🔥
                        </span>
                      )}
                    </div>
                    <div className="flex items-center gap-2 mt-0.5 flex-wrap">
                      <span className="text-[10px] text-slate-400">
                        التصنيف: <strong className="text-indigo-600 dark:text-indigo-400">{p.categoryAr}</strong> • {p.ageGroup}
                      </span>
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 mt-2 text-[10px] bg-slate-50 dark:bg-slate-800/60 p-2 rounded-xl font-mono">
                      <div>
                        ...
                        <span className="font-extrabold text-indigo-600 dark:text-indigo-400">{p.wholesalePrice} دج</span>
                      </div>
                      <div>
                      ...
                      <div>
                        ...
                        <span className="font-black text-emerald-500">{p.suggestedSellingPrice || p.floorPrice + 500} دج</span>
                      </div>
                      <div>
                ...
                <div className="flex items-center justify-between pt-2 border-t border-slate-100 dark:border-slate-800 text-xs flex-wrap gap-2">
                  ...
                  <div className="flex gap-2 items-center flex-wrap">
                    ...
                    <button
                      ...
                      className="px-3 py-1.5 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white font-black text-xs flex items-center gap-1.5 transition shadow-sm cursor-pointer"
                    >
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2.5">
            ...
            <div className="flex items-center gap-2 flex-wrap">
              ...
              <button
                ...
                className="px-3.5 py-2 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white font-extrabold text-xs flex items-center gap-1.5 shadow-xs whitespace-nowrap cursor-pointer"
              >
                  ...
                  >
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                      <div className="flex items-center gap-3 flex-1 min-w-0">
                        <div className="w-12 h-12 rounded-2xl bg-indigo-100 dark:bg-indigo-950/60 text-indigo-600 dark:text-indigo-400 flex items-center justify-center font-black text-base shrink-0 border border-indigo-200 dark:border-indigo-800">
                          {s.fullName.charAt(0)}
                        </div>
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center gap-2 flex-wrap">
                            <h4
                              ...
                              className="text-xs font-black text-slate-900 dark:text-white cursor-pointer hover:text-indigo-600 dark:hover:text-indigo-400 transition flex items-center gap-1.5"
                              title="اضغط للدخول إلى داشبورد هذا البائع"
                            >
                              <span>{s.fullName}</span>
                              <span className="text-slate-400 font-normal">({s.storeName})</span>
                            </h4>
                            <span className="px-2 py-0.5 rounded-full bg-indigo-100 text-indigo-700 dark:bg-indigo-950 dark:text-indigo-300 text-[10px] font-bold">
                          ...
                          {s.email && <span className="text-[10px] text-indigo-500 font-mono block">{s.email}</span>}
                          {s.password && (
                      ...
                      <div className="flex items-center gap-2 flex-wrap shrink-0">
                        ...
                        <a
                          ...
                          className="px-3 py-1.5 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white font-black text-xs flex items-center gap-1.5 shadow-xs transition cursor-pointer"
        ...
        <div className="fixed inset-0 z-50 bg-slate-950/80 backdrop-blur-md flex items-center justify-center p-4 animate-in fade-in duration-200">
          <div className="w-full max-w-lg bg-slate-900 border border-slate-800 rounded-3xl p-6 sm:p-8 shadow-2xl space-y-6 relative text-right max-h-[90vh] overflow-y-auto">
            ...
            >
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full py-3 pr-10 pl-4 bg-slate-950 border border-slate-800 rounded-2xl text-xs font-bold text-white placeholder-slate-600 focus:outline-none focus:border-emerald-500 transition font-mono"
                  />
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="space-y-1.5">
                  ...
                  <input
                    ...
                    className="w-full py-3 px-4 bg-slate-950 border border-slate-800 rounded-2xl text-xs font-bold text-white placeholder-slate-600 focus:outline-none focus:border-emerald-500 transition"
                  />
                </div>
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full py-3 pr-10 pl-4 bg-slate-950 border border-slate-800 rounded-2xl text-xs font-bold text-white placeholder-slate-600 focus:outline-none focus:border-emerald-500 transition"
                    />
                  </div>
                </div>
              </div>
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="relative">
                    ...
                    <select
                      ...
                      className="w-full py-3 pr-10 pl-4 bg-slate-950 border border-slate-800 rounded-2xl text-xs font-bold text-white focus:outline-none focus:border-emerald-500 transition appearance-none cursor-pointer"
                    >
              ...
              <div className="space-y-1.5 pt-2 border-t border-slate-800/80">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="0"
                    className="w-full py-3 pr-10 pl-4 bg-slate-950 border border-slate-800 rounded-2xl text-xs font-bold text-emerald-400 placeholder-slate-600 focus:outline-none focus:border-emerald-500 transition font-mono"
                  />
                </div>
              </div>
              ...
              <button
                type="submit"
                className="w-full py-3.5 rounded-2xl bg-gradient-to-r from-emerald-500 to-teal-500 hover:from-emerald-400 hover:to-teal-400 text-slate-950 font-black text-sm transition shadow-lg shadow-emerald-500/20 flex items-center justify-center gap-2 cursor-pointer mt-2"
              >
      ...
      {/* ---------------- 4. WALLET & WITHDRAWALS (ادارة جميع السحوبات) ---------------- */}
      {activeAdminTab === 'wallet' && (
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <h3 className="text-xs font-extrabold text-slate-800 dark:text-white uppercase">
              إدارة جميع السحوبات والمحفظة المالية (Withdrawal Requests)
            </h3>
            {/* Filter Pills */}
            <div className="flex items-center gap-1.5 text-xs font-bold">
              {(['ALL', 'PENDING', 'APPROVED', 'REJECTED'] as const).map((st) => (
                ...
                >
                  {st === 'ALL' ? 'الكل' : st === 'PENDING' ? 'بانتظار الموافقة' : st === 'APPROVED' ? 'مقبولة' : 'مرفوضة'}
                </button>
              ))}
            </div>
          </div>
              ...
              .map((w) => (
                ...
                >
                  <div className="flex justify-between items-center border-b border-slate-100 dark:border-slate-800 pb-2">
                    <div className="flex items-center gap-2">
                      <span className="font-mono text-indigo-600 dark:text-indigo-400 font-black">{w.id}</span>
                      <button
                        onClick={() => {
                        ...
                        className="text-slate-900 dark:text-white font-extrabold hover:text-indigo-600 dark:hover:text-indigo-400 cursor-pointer flex items-center gap-1 transition"
                        title="اضغط للدخول إلى داشبورد هذا البائع"
                      >
                    ...
                    >
                      {w.status === 'APPROVED' ? '✔ تم الصرف' : w.status === 'PENDING' ? '⏳ معلق' : '✖ مرفوض'}
                    </span>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <div>
                      ...
                      <span className="text-[10px] text-slate-400 block mt-1">طريقة السحب: {w.method}</span>
                    </div>
                    <div>
                      <span className="text-[10px] text-slate-400 block">تفاصيل الحساب:</span>
                      <span className="font-mono font-bold text-slate-800 dark:text-slate-200 block">{w.accountDetails}</span>
                      <span className="text-[10px] text-slate-400 block">{w.requestDate}</span>
                    </div>
                  </div>
                  ...
                  {w.status === 'PENDING' && (
                    <div className="flex justify-end gap-2 pt-2 border-t border-slate-100 dark:border-slate-800">
                      <button
                        ...
                        className="px-4 py-1.5 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white font-black text-xs"
                      >
                        ✔ موافقة وصرف الرصيد
                      </button>
                      <button
              ...
              >
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button
                    ...
                    className="px-3 py-1.5 rounded-xl bg-indigo-600 text-white font-bold text-[10px]"
                  >
                    حفظ الرف
                  </button>
                  <button
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="px-3.5 py-1.5 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white font-black text-xs flex items-center gap-1.5 cursor-pointer shadow-xs transition"
            >
              ...
              >
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button
                    ...
                    className="p-1.5 rounded-lg hover:bg-indigo-50 dark:hover:bg-indigo-950/50 text-indigo-600 dark:text-indigo-400 transition cursor-pointer"
                  >
        ...
        <div className="fixed inset-0 z-50 bg-slate-950/80 backdrop-blur-sm flex justify-center items-center p-4">
          <div className="w-full max-w-md bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-5 shadow-2xl space-y-4 text-slate-900 dark:text-slate-100">
            <div className="flex items-center justify-between pb-2 border-b border-slate-200 dark:border-slate-800">
              <h3 className="text-sm font-black flex items-center gap-2 text-indigo-600 dark:text-indigo-400">
            ...
            <div className="space-y-3 text-xs font-bold">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 rounded-xl bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 text-slate-900 dark:text-white font-bold focus:outline-none focus:border-indigo-500"
                />
              </div>
              ...
              <div className="grid grid-cols-2 gap-2">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 rounded-xl bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 text-slate-900 dark:text-white font-bold text-center text-lg focus:outline-none focus:border-indigo-500"
                  />
                </div>
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 rounded-xl bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 text-slate-900 dark:text-white font-mono focus:outline-none focus:border-indigo-500"
                  />
                </div>
              </div>
            </div>
            ...
            <div className="flex justify-end gap-2 pt-3 border-t border-slate-200 dark:border-slate-800">
              ...
              <button
                ...
                className="px-5 py-2 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white font-black text-xs transition cursor-pointer shadow-xs"
              >
                إضافة التصنيف
              </button>
            </div>
            ...
            <div className="space-y-3 text-xs font-bold">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 rounded-xl bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 font-bold focus:outline-none focus:border-indigo-500"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 rounded-xl bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 focus:outline-none focus:border-indigo-500"
                />
              </div>
              ...
              <div className="grid grid-cols-2 gap-2">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 rounded-xl bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 text-center text-lg focus:outline-none focus:border-indigo-500"
                  />
                </div>
                <div>
                  <label className="text-[11px] text-slate-600 dark:text-slate-400 block mb-1">ترتيب العرض:</label>
                  <input
                    ...
                    className="w-full px-3 py-2 rounded-xl bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 font-mono focus:outline-none focus:border-indigo-500"
                  />
                </div>
              </div>
              ...
              <div className="p-4 rounded-2xl bg-sky-500/5 border border-sky-500/20 space-y-4 animate-in fade-in duration-300">
                    ...
                    <div className="grid grid-cols-3 gap-2 text-xs">
                      ...
                      <div>
                        ...
                        <input
                          ...
                          className="w-full px-2.5 py-1 rounded-lg bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 font-bold text-emerald-600"
                        />
                      </div>
                      <div>
                        ...
                        <input
                          ...
                          className="w-full px-2.5 py-1 rounded-lg bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 font-bold text-indigo-600"
                        />
                      </div>
                    </div>
                ...
                <div className="flex items-center justify-end gap-2 pt-2 border-t border-sky-500/20">
                  ...
                  <button
                    ...
                    className="px-6 py-2 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white font-black text-xs transition cursor-pointer shadow-md flex items-center gap-1.5"
                  >
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="px-3.5 py-1.5 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white font-black text-xs flex items-center gap-1.5"
            >
            ...
            {couriers.map((c) => (
              ...
              >
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2.5 pb-2.5 border-b border-slate-100 dark:border-slate-800">
                  <div className="flex items-center gap-2.5">
                    <div className={`p-2 rounded-2xl ${c.isDisabled ? 'bg-amber-100 text-amber-600 dark:bg-amber-950/80 dark:text-amber-400' : 'bg-indigo-50 text-indigo-600 dark:bg-indigo-950 dark:text-indigo-400'}`}>
                    ...
                    <div>
                      <h4 className="font-extrabold text-sm text-slate-900 dark:text-white flex items-center gap-2">
                        ...
                        {c.isDisabled ? (
                          ...
                          <span className="px-2 py-0.5 rounded-md bg-emerald-100 dark:bg-emerald-950 text-emerald-800 dark:text-emerald-300 font-extrabold text-[10px]">
                            ✓ مفعّلة وشغالة
                          </span>
                        )}
                      </h4>
      ...
      {activeAdminTab === 'suppliers' && (
        <div className="space-y-6">
          <div className="p-4 bg-indigo-500/10 border border-indigo-500/20 rounded-2xl text-xs text-indigo-900 dark:text-indigo-300 flex items-center justify-between gap-3">
            <div className="flex items-center gap-2">
          ...
          <form onSubmit={handleSaveFeeSettings} className="p-5 rounded-3xl bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 shadow-xs space-y-4">
            <div className="flex justify-between items-center border-b border-slate-100 dark:border-slate-800 pb-3">
              ...
              <button
                type="submit"
                className="px-4 py-2 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white font-black text-xs flex items-center gap-1.5 shadow-md transition cursor-pointer"
              >
                <Check className="w-4 h-4" />
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full py-2.5 px-3 rounded-xl bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 font-mono text-sm text-indigo-600 font-black"
                  />
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full py-2.5 px-3 rounded-xl bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 font-mono text-sm text-emerald-600 font-black"
                  />
                  <span className="absolute left-3 top-1/2 -translate-y-1/2 text-slate-400 font-black">%</span>
                </div>
            ...
            <div className="flex flex-col sm:flex-row justify-between sm:items-center gap-3 border-b border-slate-100 dark:border-slate-800 pb-3">
              ...
              <div className="flex items-center gap-2 flex-wrap">
                <button
                  ...
                  className="px-3.5 py-1.5 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white font-black text-xs flex items-center gap-1.5 shadow-md transition cursor-pointer"
                >
                  <Plus className="w-4 h-4" />
                ...
                .map((s) => (
                  ...
                  >
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-slate-200/60 dark:border-slate-700/60 pb-2.5">
                      <div className="flex items-center gap-2.5">
                        <div className="p-2 rounded-xl bg-indigo-100 text-indigo-700 dark:bg-indigo-950 dark:text-indigo-300 font-bold">
                      ...
                      <div className="flex items-center gap-2 flex-wrap">
                        ...
                        <button
                          ...
                          className="px-3 py-1.5 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white font-black text-[11px] flex items-center gap-1.5 shadow-xs transition cursor-pointer"
                        ...
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="px-3 py-1.5 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white font-black text-[11px] flex items-center gap-1.5 shadow-xs transition cursor-pointer"
                        ...
                        {s.status === 'PENDING' && (
                          <>
                            <button
                              ...
                              className="px-3 py-1.5 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white font-black text-[11px] shadow-xs cursor-pointer"
                            >
                              قبول المورد ✔
                            </button>
                            <button
                        ...
                        {s.status === 'SUSPENDED' && (
                          <button
                            onClick={() => handleUpdateSupplierStatus(s.id, 'APPROVED')}
                            className="px-3 py-1.5 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white font-black text-[11px] cursor-pointer"
                          >
                            إعادة التفعيل ⚡
                          </button>
                        )}
                        ...
                        <button
                          ...
                          className="px-3 py-1.5 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white font-black text-[11px] cursor-pointer"
                        >
                          تسوية أرصدة 💰
                        </button>
                    ...
                    >
                      ...
                      <div className="flex items-center gap-2 shrink-0">
                        <button
                          ...
                          className="px-4 py-2 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white font-black text-xs shadow-xs cursor-pointer flex items-center gap-1"
                        >
                          <Check className="w-4 h-4" />
            ...
            <div className="space-y-3 text-xs font-bold">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full py-2.5 px-3 rounded-xl bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 font-mono text-sm font-black text-emerald-600"
                />
              </div>
        ...
        <div className="fixed inset-0 z-50 bg-slate-950/80 backdrop-blur-xs flex justify-center items-center p-4 animate-fadeIn overflow-y-auto">
          <div className="w-full max-w-lg bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-6 shadow-2xl space-y-4 text-slate-900 dark:text-slate-100 my-8">
            ...
            <form onSubmit={handleAddSupplierSubmit} className="space-y-3.5 text-xs">
              ...
              <div className="space-y-1">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full py-2.5 pr-10 pl-4 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-2xl text-xs font-bold text-slate-900 dark:text-white placeholder-slate-400 focus:outline-none focus:border-indigo-500 transition font-mono"
                  />
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div className="space-y-1">
                  ...
                  <input
                    ...
                    className="w-full py-2.5 px-3.5 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-2xl text-xs font-bold text-slate-900 dark:text-white placeholder-slate-400 focus:outline-none focus:border-indigo-500 transition"
                  />
                </div>
                ...
                <div className="space-y-1">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full py-2.5 pr-10 pl-3.5 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-2xl text-xs font-bold text-slate-900 dark:text-white placeholder-slate-400 focus:outline-none focus:border-indigo-500 transition"
                    />
                  </div>
                </div>
              </div>
                ...
                <div className="space-y-1">
                  ...
                  <div className="relative">
                    ...
                    <select
                      ...
                      className="w-full py-2.5 pr-10 pl-3.5 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-2xl text-xs font-bold text-slate-900 dark:text-white focus:outline-none focus:border-indigo-500 transition"
                    >
                      {ALGERIA_WILAYAS.map((w) => (
                        <option key={w.code} value={w.nameAr}>
                          {w.nameAr}
              ...
              <div className="p-3 bg-indigo-50/60 dark:bg-indigo-950/40 border border-indigo-100 dark:border-indigo-900/60 rounded-2xl space-y-1.5">
                <label className="text-xs font-extrabold text-indigo-900 dark:text-indigo-200 block">
                ...
                <div className="flex items-center gap-4 text-xs font-bold">
                  <label className="flex items-center gap-1.5 cursor-pointer">
                    ...
                    />
                    <span className="text-emerald-700 dark:text-emerald-400 font-extrabold">✔ معتمد ومفعل فوراً (APPROVED)</span>
                  </label>
                  <label className="flex items-center gap-1.5 cursor-pointer">
                    <input
                      type="radio"
              ...
              <div className="flex justify-end gap-2 pt-3 border-t border-slate-100 dark:border-slate-800">
                ...
                <button
                  type="submit"
                  className="px-5 py-2 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white font-black text-xs cursor-pointer shadow-md transition flex items-center gap-1.5"
                >
        ...
        <div className="space-y-3">
          ...
          <div className="space-y-2">
            {coupons.map((c) => (
              ...
              >
                <div>
                  <span className="font-mono text-indigo-600 dark:text-indigo-400 font-black text-sm block">
                    {c.code}
                  </span>
                  <span className="text-[10px] text-slate-400">
              ...
              >
                <div>
                  ...
                  <div className="flex items-center gap-1 mt-1">
                    <span className="px-2 py-0.5 rounded bg-indigo-100 text-indigo-800 dark:bg-indigo-950 dark:text-indigo-300 font-bold text-[9px]">
                      دور: {u.role}
                    </span>
                  </div>
                </div>
        ...
        <div className="p-4 rounded-3xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 space-y-4 text-xs">
          ...
          <div className="space-y-3">
            ...
            <button
              ...
              className="px-5 py-2.5 rounded-xl bg-indigo-600 text-white font-black shadow-md"
            >
              حفظ الإعدادات
            </button>
          </div>
      ...
      {activeAdminTab === 'notifications' && (
        <div className="space-y-4 text-xs">
          {/* Header Banner */}
          <div className="p-4 rounded-3xl bg-gradient-to-r from-violet-950 via-indigo-950 to-slate-950 border border-violet-800 text-white shadow-xl flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
            <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2 shrink-0">
              ...
              <button
                onClick={() => setIsAdminNotifModalOpen(true)}
                className="px-3.5 py-2 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white font-black text-xs flex items-center gap-1.5 shadow-md transition cursor-pointer"
              >
          ...
          <div className="p-4 rounded-3xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 space-y-3.5 shadow-xs">
            ...
            <div className="flex items-center justify-between pt-1">
              ...
              <button
                ...
                className="px-5 py-2.5 rounded-xl bg-gradient-to-r from-violet-600 to-indigo-600 hover:from-violet-500 hover:to-indigo-500 text-white font-black text-xs shadow-md flex items-center gap-1.5 cursor-pointer transition"
              >
          ...
          <div className="p-4 rounded-3xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 space-y-3 text-xs">
            ...
            <div className="space-y-3">
              ...
              <button
                ...
                className="px-5 py-2.5 rounded-xl bg-emerald-600 text-white font-black shadow-md cursor-pointer"
              >
                حفظ القوالب
              </button>
            </div>
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <span className="inline-block px-2.5 py-0.5 rounded-full bg-indigo-100 dark:bg-indigo-950/80 text-indigo-700 dark:text-indigo-300 font-black text-[11px] mt-0.5">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 rounded-xl bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 font-mono font-bold text-emerald-600 dark:text-emerald-400"
                  />
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="from-purple-500 to-indigo-600">بنفسجي فاخر (Royal Purple)</option>
                    <option value="from-emerald-500 to-teal-700">زمردي (Emerald Green)</option>
