      ...
      <div className="w-full max-w-3xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl shadow-2xl relative text-right flex flex-col max-h-[90vh] overflow-hidden">
        ...
        <div className="p-6 sm:p-8 overflow-y-auto space-y-8 text-slate-700 dark:text-slate-300 leading-relaxed text-sm">
          ...
          <section className="space-y-3">
            ...
            <p className="text-xs text-purple-600 dark:text-purple-400 font-bold pt-1">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="p-4 rounded-2xl bg-purple-50/50 dark:bg-purple-950/20 border border-purple-100 dark:border-purple-900/40 space-y-1">
              <h4 className="font-extrabold text-xs text-purple-900 dark:text-purple-300">خامساً: حماية البيانات</h4>
            ...
            <div className="p-4 rounded-2xl bg-purple-50/50 dark:bg-purple-950/20 border border-purple-100 dark:border-purple-900/40 space-y-1">
              <h4 className="font-extrabold text-xs text-purple-900 dark:text-purple-300">سادساً: الاحتفاظ بالبيانات</h4>
              <p className="text-xs text-slate-600 dark:text-slate-400 leading-relaxed">
          ...
          {/* Section 12: Contact */}
          <section className="p-5 rounded-2xl bg-purple-600 text-white space-y-3 text-center">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 text-xs font-mono font-bold pt-1">
              <span className="flex items-center gap-1.5 bg-purple-700/60 px-3 py-1.5 rounded-xl border border-purple-500/40">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="flex items-center gap-1.5 bg-purple-700/60 px-3 py-1.5 rounded-xl border border-purple-500/40 underline hover:text-purple-200 transition"
              >
