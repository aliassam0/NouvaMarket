    ...
    <div className="fixed inset-0 z-50 bg-slate-900/70 backdrop-blur-md flex items-center justify-center p-4 animate-in fade-in duration-200">
      <div className="w-full max-w-3xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl shadow-2xl relative text-right flex flex-col max-h-[90vh] overflow-hidden">
        ...
        <div className="p-6 sm:p-8 overflow-y-auto space-y-8 text-slate-700 dark:text-slate-300 leading-relaxed text-sm">
          {/* Welcome Intro */}
          <div className="p-5 rounded-2xl bg-emerald-50/60 dark:bg-emerald-950/30 border border-emerald-200/80 dark:border-emerald-800/50 space-y-2">
            <h3 className="font-black text-emerald-900 dark:text-emerald-300 text-base flex items-center gap-2">
          ...
          <section className="space-y-3">
            <h3 className="text-base font-black text-slate-900 dark:text-white border-r-4 border-emerald-500 pr-3">
              أولاً: التعريفات
            </h3>
          ...
          <section className="space-y-3">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="p-4 rounded-2xl bg-emerald-50/50 dark:bg-emerald-950/20 border border-emerald-100 dark:border-emerald-900/40 space-y-2">
                <h4 className="font-extrabold text-xs text-emerald-800 dark:text-emerald-300">✅ يلتزم المسوق بما يلي:</h4>
          ...
          {/* Section 18: Contact */}
          <section className="p-5 rounded-2xl bg-emerald-600 text-white space-y-2 text-center">
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-block mt-1 font-mono font-extrabold text-white underline hover:text-emerald-200 transition text-sm"
            >
