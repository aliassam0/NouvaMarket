...
export function LandingPage({ onEnterApp, onShowToast }: LandingPageProps) {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 font-sans selection:bg-purple-500 selection:text-white dir-rtl text-right overflow-x-hidden">
      ...
      {/* Hero Section */}
      <section className="relative pt-12 sm:pt-24 pb-16 sm:pb-28 overflow-hidden z-10 bg-gradient-to-br from-[#F5F3FF]/40 via-white to-[#EDE9FE]/60">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-8">
            
            {/* Text Content */}
            <div className="flex-1 text-center lg:text-start space-y-8 z-20">
              
              {/* Top Trust Pill */}
              <div className="inline-flex items-center justify-center lg:justify-start gap-2 px-5 py-2 rounded-full bg-white border border-[#E9D5FF] text-[#5E44FF] text-xs sm:text-sm font-bold shadow-sm">
                <Sparkles className="w-4 h-4 text-[#5E44FF]" />
                <span>منصة التجارة الإلكترونية الأولى في الجزائر بدون رأس مال!</span>
              </div>

              {/* Main Headline */}
              <h1 className="text-4xl sm:text-5xl lg:text-7xl font-black text-[#0F172A] leading-[1.25] tracking-tight">
                حقق أرباحًا يومية من <br className="hidden sm:inline" />
                <span className="text-[#5E44FF]">
                  التجارة الإلكترونية
                </span>
              </h1>
              ...
              <p className="text-sm sm:text-base lg:text-lg text-slate-600 font-medium leading-relaxed max-w-2xl mx-auto lg:mx-0">
                لا تحتاج شراء مخزون أو امتلاك رأس مال! نحن نوفر لك أحدث تشكيلات الإلكترونيات والمنتجات الذكية والأجهزة الأكثر مبيعًا، التغليف، والتوصيل لـ <span className="font-bold text-slate-900">69 ولاية</span> مع الدفع عند الاستلام (COD)، وأنت تستلم أرباحك الصافية فوراً.
              </p>

              {/* Features Row */}
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-6 sm:gap-4 pt-4 border-y border-slate-100 py-6 max-w-3xl mx-auto lg:mx-0">
                <div className="flex flex-col items-center lg:items-start text-center lg:text-start gap-3">
                  ...
                  <div>
                    <h3 className="font-black text-slate-900 text-sm">أرباح يومية</h3>
                    <p className="text-[11px] sm:text-xs text-slate-500 font-medium mt-1 leading-snug">احصل على أرباحك<br/>بشكل يومي وفوري</p>
                  </div>
                </div>
                
                <div className="flex flex-col items-center lg:items-start text-center lg:text-start gap-3 sm:border-r border-slate-100 sm:pr-4">
                  <div className="w-12 h-12 rounded-2xl bg-[#EFF6FF] text-[#3B82F6] flex items-center justify-center">
                    <Truck className="w-6 h-6" />
                  </div>
                  <div>
                    <h3 className="font-black text-slate-900 text-sm">توصيل سريع</h3>
                    <p className="text-[11px] sm:text-xs text-slate-500 font-medium mt-1 leading-snug">تغطية 69 ولاية<br/>بسرعة وموثوقية</p>
                  </div>
                </div>
                ...
                <div className="flex flex-col items-center lg:items-start text-center lg:text-start gap-3 sm:border-r border-slate-100 sm:pr-4">
                  ...
                  <div>
                    <h3 className="font-black text-slate-900 text-sm">منتجات مضمونة</h3>
                    <p className="text-[11px] sm:text-xs text-slate-500 font-medium mt-1 leading-snug">أحدث المنتجات<br/>بأعلى جودة</p>
                  </div>
                </div>
                ...
                <div className="flex flex-col items-center lg:items-start text-center lg:text-start gap-3 sm:border-r border-slate-100 sm:pr-4">
                  ...
                  <div>
                    <h3 className="font-black text-slate-900 text-sm">دعم دائم</h3>
                    <p className="text-[11px] sm:text-xs text-slate-500 font-medium mt-1 leading-snug">فريق دعم جاهز<br/>لمساعدتك 24/7</p>
                  </div>
                </div>
              </div>
              ...
              <div className="pt-2 flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
                {user ? (
                  <button
                    onClick={() => onEnterApp(user.role as any)}
                    className="w-full sm:w-auto px-8 py-4 rounded-2xl bg-[#5E44FF] hover:bg-[#4E34E0] text-white font-black text-base shadow-xl shadow-[#5E44FF]/20 active:scale-95 transition-all flex items-center justify-center gap-2.5 cursor-pointer"
                  >
                    <UserCheck className="w-5 h-5 text-purple-200" />
                    <span>مرحباً {user.fullName || user.storeName} - مساحة العمل</span>
                  </button>
                ) : (
                  <>
                    <button
                      onClick={() => setIsRegisterModalOpen(true)}
                      className="w-full sm:w-auto px-8 py-4 rounded-2xl bg-[#5E44FF] hover:bg-[#4E34E0] text-white font-bold text-base shadow-xl shadow-[#5E44FF]/30 active:scale-95 transition-all flex items-center justify-center gap-2.5 cursor-pointer"
                    >
                      <span>ابدأ الربح الآن - تسجيل مجاني</span>
                      <Zap className="w-5 h-5 fill-current text-white" />
                    </button>

                    <a
                      href="#how-it-works"
                      className="w-full sm:w-auto px-8 py-4 rounded-2xl bg-white hover:bg-slate-50 border border-slate-200 text-[#5E44FF] font-bold text-base transition-all flex items-center justify-center gap-2 cursor-pointer shadow-sm"
                    >
            ...
            {/* Hero Image / 3D Graphic */}
            <div className="flex-1 relative w-full max-w-md sm:max-w-lg lg:max-w-none mx-auto flex justify-center lg:justify-end z-20">
              {/* Subtle glows behind the phone */}
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[120%] h-[120%] bg-gradient-to-tr from-[#C4B5FD]/40 via-transparent to-[#93C5FD]/30 blur-3xl -z-10 rounded-full pointer-events-none" />
              
              <img 
                src="/hero-image.png" 
                alt="Nouva Market App Interface" 
                className="relative z-10 w-full h-auto object-contain drop-shadow-2xl hover:scale-[1.02] transition-transform duration-700 ease-out"
                onError={(e) => {
                   if (e.currentTarget.src.includes('hero-image.png')) {
                     e.currentTarget.src = '/graph.png';
                   } else if (e.currentTarget.src.includes('graph.png')) {
                     e.currentTarget.src = 'https://raw.githubusercontent.com/aliassam0/NouvaMarket/main/public/hero-image.png';
                   }
                }}
              />
            </div>
