        ...
        <div className="p-5 flex-1 space-y-4">
          ...
          {step === 1 && (
            <div className="space-y-4">
              ...
              <div className="p-3.5 rounded-2xl bg-gradient-to-r from-violet-50 to-purple-50 dark:from-violet-950/40 dark:to-purple-950/40 border border-purple-500/30 grid grid-cols-2 gap-3 text-center">
