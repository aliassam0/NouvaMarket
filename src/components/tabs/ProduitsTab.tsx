            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-1.5 pt-1">
                ...
                <button
                  ...
                  className="flex-1 py-2 px-2.5 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white font-extrabold text-[10px] transition text-center flex items-center justify-center gap-1 shadow-xs cursor-pointer"
                >
