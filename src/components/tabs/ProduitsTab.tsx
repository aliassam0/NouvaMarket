          ...
          return (
            ...
            >
                  ...
                  <div className="pt-1 border-t border-slate-100 dark:border-slate-800 flex justify-between items-center">
                    ...
                    {product.upsells && product.upsells.length > 0 && (
                      <span
                        ...
                        className="inline-flex items-center gap-1 px-1.5 py-0.5 rounded-md bg-purple-50 dark:bg-purple-950/60 border border-purple-200 dark:border-purple-800/60 text-purple-700 dark:text-purple-300 text-[10px] font-bold"
                      >
                        <Layers className="w-3 h-3 text-purple-600 dark:text-purple-400" />
                        <span>UpSell ({product.upsells.length})</span>
                      </span>
                    )}
                  </div>
                </div>
              ...
              <div className="space-y-1.5 pt-1">
                {/* 1-Click Sync to External Store Button */}
                {onOpenSyncToStore && (
                  <button
                ...
                <div className="flex flex-col sm:flex-row gap-1.5">
                  <button
                    onClick={() => onOpenProduct(product)}
                    className="px-2 py-1.5 rounded-xl bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-300 text-[10px] font-bold transition text-center"
                    title="تفاصيل المنتج"
                  >
                    التفاصيل
                  </button>
                  <button
                    ...
                    className="flex-1 py-1.5 px-2.5 rounded-xl bg-purple-600 hover:bg-purple-500 text-white font-extrabold text-[10px] transition text-center flex items-center justify-center gap-1 shadow-xs cursor-pointer"
                  >
                  ...
                  <button
                    ...
                    className="py-1.5 px-2 rounded-xl bg-violet-600 hover:bg-violet-500 text-white font-extrabold text-[10px] transition text-center flex items-center justify-center gap-1 shadow-xs cursor-pointer"
                    title="مشاركة المنتج"
                  >
