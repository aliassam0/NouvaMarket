  ...
  return (
    <div className="fixed inset-0 z-50 bg-slate-900/80 backdrop-blur-xs flex items-center justify-center p-3 sm:p-4">
      <div className="bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-2xl w-full max-w-xl overflow-hidden flex flex-col max-h-[92vh]">
        {/* Modal Header */}
        <div className="p-4 bg-gradient-to-r from-violet-600 via-indigo-600 to-slate-900 text-white flex items-center justify-between shrink-0">
                  ...
                  >
                    ...
                    <div className="flex items-center justify-between gap-2 border-b border-slate-100 dark:border-slate-800/80 pb-2">
                      <div className="flex items-center gap-2 min-w-0">
                        ...
                        {link.active ? (
                          <span className="px-2 py-0.5 rounded-full bg-emerald-500/15 text-emerald-700 dark:text-emerald-400 font-extrabold text-[10px] flex items-center gap-1 border border-emerald-500/30 shrink-0">
                        ...
                        <div className="flex items-center gap-1.5">
                          ...
                          {isPriceModified && (
                            <button
                              ...
                              className="px-2.5 py-1.5 rounded-lg bg-emerald-600 hover:bg-emerald-500 text-white font-extrabold text-[11px] transition shadow-xs cursor-pointer"
                            >
                              حفظ
                            </button>
                          )}
                      ...
                      <div className="flex items-center justify-between text-[11px] pt-1 border-t border-slate-200/60 dark:border-slate-700/60">
                        ...
                        <span
                          className={`font-black ${
                            linkProfit > 0 ? 'text-emerald-600 dark:text-emerald-400' : 'text-rose-500'
                          }`}
                        >
                    ...
                    <div className="grid grid-cols-4 gap-1.5">
                      ...
                      <button
                        ...
                        className="py-1.5 px-2 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white font-extrabold text-[10px] flex items-center justify-center gap-1 transition cursor-pointer shadow-2xs"
                      >
            ...
            <form onSubmit={handleCreateNewLink} className="space-y-4">
              ...
              <div>
                ...
                <div className="mt-1 flex items-center justify-between text-[11px]">
                  ...
                  <span
                    className={`font-black ${
                      newProfit > 0 ? 'text-emerald-600 dark:text-emerald-400' : 'text-rose-500'
                    }`}
                  >
              ...
              <button
                type="submit"
                className="w-full py-3 px-4 rounded-2xl bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-500 hover:to-teal-500 text-white font-extrabold text-xs shadow-md transition flex items-center justify-center gap-2 cursor-pointer"
              >
