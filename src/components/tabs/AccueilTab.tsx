...
export function AccueilTab({
  ...
  return (
    <div className="flex-1 pb-24 overflow-y-auto space-y-4 p-4 text-slate-900 dark:text-slate-100">
      ...
      <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-violet-600 via-purple-600 to-slate-900 text-white p-5 shadow-xl">
        ...
        <div className="flex justify-between items-start mb-3">
          ...
          <button
            ...
            className="flex items-center gap-1 px-3.5 py-2 rounded-2xl bg-purple-500 hover:bg-purple-400 active:scale-95 text-white font-bold text-xs transition shadow-md"
          >
