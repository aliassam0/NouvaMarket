...
export function CustomerShareOrderView({ product, onBackToApp, onShowToast }: CustomerShareOrderViewProps) {
  ...
  const handleConfirmOrder = async (e: React.FormEvent) => {
    ...
    const orderPayload: Partial<Order> = {
      ...
      resellerId: sellerIdParam || undefined,
      resellerName: sellerNameParam || undefined,
      resellerPhone: sellerPhoneParam || undefined,
      resellerEmail: sellerEmailParam || undefined,
