    ...
    <div className="flex-1 pb-24 overflow-y-auto p-4 text-slate-900 dark:text-slate-100 space-y-4">
      ...
      <div className="grid grid-cols-2 gap-3">
        <div className="p-4 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 shadow-xs">
          ...
          <span className="text-[10px] text-purple-600 block mt-1 font-bold">
          ...
          {daysData.map((d, i) => {
            ...
            return (
              <div key={i} className="flex-1 flex flex-col items-center gap-1.5 h-full justify-end group">
                ...
                <div
                  className="w-full rounded-t-lg bg-gradient-to-t from-violet-600 to-purple-500 hover:from-purple-500 hover:to-purple-400 transition-all duration-300"
