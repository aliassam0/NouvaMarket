  ...
  return (
    <div className="flex-1 pb-24 overflow-y-auto p-4 text-slate-900 dark:text-slate-100 space-y-4">
      ...
      <div className="flex items-center justify-between">
        ...
        <span className="px-2.5 py-0.5 rounded-full bg-gradient-to-r from-violet-600 to-indigo-600 text-white text-[10px] font-bold shadow-xs">
          Gemini AI Powered ⚡
        </span>
      </div>
      ...
      <div className="p-4 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 shadow-xs space-y-3">
            ...
            {(
              ...
              <button
                ...
                className={`py-2 px-1 rounded-xl transition border text-center font-bold text-[11px] ${
                  platform === p.id
                    ? 'bg-gradient-to-r from-violet-600 to-indigo-600 text-white border-violet-600 shadow-sm'
        ...
        <button
          ...
          className="w-full py-3 rounded-2xl bg-gradient-to-r from-violet-600 via-indigo-600 to-indigo-700 hover:from-violet-500 hover:to-indigo-500 text-white font-extrabold text-xs transition shadow-md flex items-center justify-center gap-2"
        >
      ...
      <div className="p-4 rounded-2xl bg-gradient-to-br from-violet-50/80 via-white to-indigo-50/70 dark:from-slate-900 dark:via-slate-900 dark:to-indigo-950/50 border border-violet-200/80 dark:border-violet-800/50 shadow-md space-y-3">
        ...
        <div className="grid grid-cols-2 gap-2">
          ...
          <button
            ...
            className="py-2.5 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white font-bold text-xs flex items-center justify-center gap-1.5 transition shadow-xs"
          >
        ...
        <button
          ...
          className="w-full py-3 rounded-xl bg-gradient-to-r from-emerald-600 via-teal-600 to-emerald-700 hover:from-emerald-500 hover:to-teal-500 active:scale-98 text-white font-black text-xs flex items-center justify-center gap-2 transition shadow-md border border-emerald-500/30"
        >
