        ...
        <div className="p-3 border-t border-slate-100 bg-slate-50/80 space-y-2 shrink-0">
          {onOpenNewOrder && (
            <button
              ...
              className="w-full py-2 px-2.5 rounded-xl bg-gradient-to-r from-violet-600 to-indigo-600 hover:from-violet-700 hover:to-indigo-700 text-white text-xs font-black flex items-center justify-center gap-1.5 transition active:scale-95 shadow-sm cursor-pointer"
              title="تسجيل طلبية مبيعات جديدة لزبونك (التغليف والمراجعة والتوصيل على الإدارة)"
            >
              <ShoppingBag className="w-3.5 h-3.5" />
              {!isCollapsed && <span>➕ بيع مباشر لزبون</span>}
            </button>
          )}
