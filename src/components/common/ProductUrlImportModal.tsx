    ...
    <div className="fixed inset-0 z-50 bg-slate-950/80 backdrop-blur-sm flex justify-center items-center p-4 overflow-y-auto">
      <div className="w-full max-w-3xl bg-slate-900 border border-slate-800 rounded-3xl p-5 shadow-2xl space-y-4 text-slate-100 my-6 max-h-[90vh] flex flex-col">
        ...
        <div className="p-4 rounded-2xl bg-slate-950 border border-slate-800 space-y-3 shrink-0">
          <label className="text-xs font-extrabold text-indigo-300 flex items-center justify-between">
          ...
          <div className="flex flex-col sm:flex-row items-stretch gap-2">
            <div className="relative flex-1">
              <input
                ...
                className="w-full px-3.5 py-2.5 rounded-xl bg-slate-900 border border-slate-700 text-white font-mono text-xs focus:border-indigo-500 transition placeholder:text-slate-600"
              />
            </div>
            ...
            <button
              ...
              disabled={isLoading}
              className="px-5 py-2.5 rounded-xl bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-500 hover:to-purple-500 text-white font-extrabold text-xs flex items-center justify-center gap-2 shadow-lg transition active:scale-95 disabled:opacity-50 cursor-pointer shrink-0"
            >
              {isLoading ? (
                <>
                ...
                return (
                  <div
                    ...
                    className={`p-4 rounded-2xl border transition-all space-y-3 text-xs ${
                      isSelected
                        ? 'bg-slate-950 border-indigo-500/70 shadow-lg'
                  ...
                  >
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1 space-y-2">
                        {/* Name */}
                        <div>
                          <label className="text-[10px] text-indigo-400 font-extrabold block mb-0.5">
                            اسم المنتج:
                          </label>
                          <input
                            type="text"
                            ...
                            className="w-full px-2.5 py-1.5 rounded-lg bg-slate-900 border border-slate-800 text-white font-bold text-xs focus:border-indigo-500"
                          />
                        </div>
                        ...
                        <div>
                          ...
                          <textarea
                            ...
                            rows={2}
                            className="w-full px-2.5 py-1.5 rounded-lg bg-slate-900 border border-slate-800 text-slate-200 text-xs focus:border-indigo-500 resize-y"
                          />
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 pt-2 border-t border-slate-800/80 bg-slate-900/50 p-2.5 rounded-xl">
                      <div>
                        <label className="text-[9px] text-indigo-400 font-extrabold block mb-0.5">
                        ...
                        <input
                          ...
                          className="w-full px-2 py-1 rounded-lg bg-slate-950 border border-indigo-500/40 text-white font-mono font-bold text-xs"
                        />
                      </div>

                      <div>
                        <label className="text-[9px] text-emerald-400 font-extrabold block mb-0.5">
                          السعر المقترح (DZD):
                        </label>
                        <input
                          type="number"
                          ...
                          className="w-full px-2 py-1 rounded-lg bg-slate-950 border border-emerald-500/40 text-emerald-300 font-mono font-bold text-xs"
                        />
                      </div>
        ...
        <div className="flex flex-wrap items-center justify-between gap-2 border-t border-slate-800 pt-3 shrink-0">
          ...
          <button
            ...
            className="px-5 py-2.5 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white font-extrabold text-xs flex items-center gap-2 shadow-lg transition active:scale-95 disabled:opacity-50 cursor-pointer"
          >
            <Download className="w-4 h-4" />
