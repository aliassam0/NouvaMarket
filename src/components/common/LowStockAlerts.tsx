        ...
        <div className="p-3 bg-slate-100 dark:bg-slate-850 border-b border-slate-200 dark:border-slate-800 flex flex-wrap items-center justify-between gap-2 shrink-0">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="px-3 py-1.5 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white font-extrabold text-xs flex items-center gap-1.5 shadow-xs transition cursor-pointer"
            >
        ...
        <div className="p-4 overflow-y-auto space-y-3.5 text-xs flex-1 bg-slate-50 dark:bg-slate-900">
          {lowStockItems.length === 0 ? (
            <div className="p-12 text-center space-y-3">
              <div className="w-16 h-16 rounded-full bg-emerald-100 dark:bg-emerald-950 text-emerald-600 dark:text-emerald-400 flex items-center justify-center mx-auto text-2xl font-black">
                ✔
              </div>
                          ...
                          {editingThresholdId === p.id ? (
                            <div className="flex items-center gap-1">
                              ...
                              <button
                                ...
                                className="px-1.5 py-0.5 rounded bg-emerald-600 text-white font-black text-[9px]"
                              >
                                حفظ
                              </button>
                            </div>
                            ...
                            <button
                              ...
                              className="font-mono font-black text-slate-700 dark:text-slate-300 underline hover:text-indigo-600 flex items-center gap-0.5 cursor-pointer"
                  ...
                  <div className="p-3 rounded-2xl bg-slate-100 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700 flex items-center justify-between gap-3">
                    ...
                    <div className="flex items-center gap-2 shrink-0">
                      ...
                      <button
                        ...
                        className="px-3.5 py-1.5 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white font-extrabold text-xs shadow-xs transition flex items-center gap-1 cursor-pointer"
                      >
