  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-5 bg-slate-950/80 backdrop-blur-md animate-fadeIn">
      <div className="w-full max-w-4xl max-h-[90vh] bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl shadow-2xl overflow-hidden flex flex-col">
        {/* Header */}
        <div className="p-4 sm:p-5 bg-gradient-to-r from-violet-600 via-purple-600 to-purple-600 text-white flex items-center justify-between shrink-0">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-base sm:text-lg font-black tracking-tight flex items-center gap-2">
                ...
                <span className="text-[10px] font-extrabold px-2 py-0.5 rounded-full bg-purple-400 text-slate-950 font-mono">
                  الأسعار الحقيقية
                </span>
              </h2>
            ...
            {filteredWilayas.map((w) => (
              ...
              >
                ...
                <div className="grid grid-cols-2 gap-2 text-xs">
                  {/* Home Delivery */}
                  <div className="p-2 rounded-xl bg-white dark:bg-slate-900 border border-purple-200 dark:border-purple-900/60 flex flex-col justify-between">
                    <span className="text-[10px] font-extrabold text-slate-500 flex items-center gap-1">
                      <Home className="w-3 h-3 text-purple-500" />
                      <span>للمنزل</span>
                    </span>
                    <span className="text-sm font-black text-purple-600 dark:text-purple-400 font-mono mt-1">
                      {w.homeFee} دج
                    </span>
                  </div>
                ...
                <div className="text-[10px] text-slate-400 flex items-center justify-between pt-0.5">
                  ...
                  <span className="text-purple-600 dark:text-purple-400 font-bold">تغطية كاملة</span>
                </div>
              </div>
            ))}
          </div>
