              ...
              <div
                className={`w-7 h-7 sm:w-8 sm:h-8 rounded-xl flex items-center justify-center transition-all ${
                  st.id === 7 && isFailed
                    ...
                    : st.active
                    ? 'bg-indigo-600 text-white ring-2 ring-indigo-400 dark:ring-indigo-700 animate-pulse scale-105'
          ...
          <div className="flex flex-wrap items-center gap-1.5">
            {!isConfirmed && (
              <>
                <button
                  ...
                  className="px-3 py-1.5 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white font-extrabold text-[11px] flex items-center gap-1 transition shadow-sm"
                >
            ...
            {isShipped && !isDelivered && (
              <button
                ...
                className="px-2.5 py-1 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white font-extrabold text-[10px] flex items-center gap-1 transition"
              >
